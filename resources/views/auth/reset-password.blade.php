<x-guest-layout>
    <x-authentication-card>
        ...
        <h1 style="font-family: 'Fraunces', Georgia, serif; font-size: 1.6rem; font-weight: 600; color: #221b12; margin: 0 0 6px;">Reset your password</h1>
        <p style="font-size: 14px; color: #5b5240; margin: 0 0 28px;">Enter your email and choose a new password.</p>
