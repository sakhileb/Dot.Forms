<x-guest-layout>
    <x-authentication-card>
        ...
        <h1 style="font-family: 'Sora', 'Inter', sans-serif; font-size: 1.6rem; font-weight: 800; color: #1A1A1A; margin: 0 0 6px;">Reset your password</h1>
        <p style="font-size: 14px; color: #6B7280; margin: 0 0 28px;">Enter your email and choose a new password.</p>
